...
usageHelp = renderText 80
    ...
    , ""
    , ""
    , "  -j<n>           Initialize a jump mark at line <n>."
    , "  -J<n>           Remove the jump mark at line <n>."
    , ""
    , "                  See \"wsedit -hc\"."
    , ""
    , ""
    ...
    , "-*- Formatting -*-"
    , ""
    , " WARNING: The -fbr+(_) - style syntax is an ugly and temporary workaround for"
    , " deeper problems originating in the current iteration of the options parser. It"
    , " is subject to change in the next major update (1.2.*) when I get around to"
    , " doing the dirty work required."
    , ""
    , ""
    , "  -fbr+<s1>_<s2>  Enable bracket highlighting for <s1> ... <s2>."
    , "  -fbr-<s1>_<s2>  Remove <s1> ... <s2> from the brackets list."
    , ""
    ...
    , ""
    , "  -fbc+<s1>_<s2>  Add <s1>, <s2> as block comment delimiters."
    , "  -fbc-<s1>_<s2>  Remove <s1>, <s2> from the block comment delimiters list."
    , ""
    , "  -fs+<s1>_<s2>   Mark everything from <s1> to <s2> as a string."
    , "  -fs-<s1>_<s2>   Remove <s1>, <s2> from the string delimiters list."
    , ""
    , "                  The old string syntax of -fs+<c1><c2> is deprecated and will"
    , "                  be removed at some point in the future."
    , ""
    , "  -fms+<s1>_<s2>  Add <s1>, <s2> as multiline string delimiters."
    , "  -fms-<s1>_<s2>  Remove <s1>, <s2> from the multiline string delimiters list."
    , ""
    , "  -fsc+<s1>_<s2>  Add <s1>, <s2> as character string delimiters."
    , "  -fsc-<s1>_<s2>  Remove <s1>, <s2> from the character string delimiters list."
    , ""
    ...
    , ""
    , "  -d~<n>          Add the opened file at indentation depth <n> to the"
