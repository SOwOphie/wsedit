...
usageHelp = renderText 80
    ...
    , ""
    , ""
    , "  -leo <c>        Set <c> as the escape character outside strings."
    , "  -leO            Unset the existing escape character."
    , ""
    , "  -les <c>        Set <c> as the escape character inside strings."
    , "  -leS            Unset the existing string escape character."
    , ""
    , ""
    , ""
